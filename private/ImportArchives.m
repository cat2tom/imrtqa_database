function handles = ImportArchives(handles)
% ImportArchives is called by ReviewInterface when the user selects to scan
% a directory for new TomoTherapy patient archives to import.
% 
